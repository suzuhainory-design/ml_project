...
class HRAttritionPredictorV2:
    ...
    def __init__(self, log_dir='../log', data_dir='../data', model_dir='../model'):
        ...
        self.logger = LogUtil(log_dir=log_dir, log_name=f'predict_v2_{timestamp}')
        self.logger.info("=" * 80)
        self.logger.info("优化版HR员工流失预测开始")
        self.logger.info("=" * 80)
    ...
    def plot_results(self):
        ...
        plot_path = os.path.join(self.data_dir, 'prediction_results_v2.png')
    ...
    def save_predictions(self):
        ...
        output_path = os.path.join(self.data_dir, 'predictions_v2.csv')
